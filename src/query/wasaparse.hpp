...
# endif
    ...
    union value_type
    {
#line 46 "/home/dockes/projets/fulltext/recoll/src/query/wasaparse.ypp"
...
#line 207 "wasaparse.tab.hpp"
    ...
    WORD = 258,                    // WORD
    QUOTED = 259,                  // QUOTED
    QUALIFIERS = 260,              // QUALIFIERS
    AND = 261,                     // AND
    UCONCAT = 262,                 // UCONCAT
    OR = 263,                      // OR
    EQUALS = 264,                  // EQUALS
    CONTAINS = 265,                // CONTAINS
    SMALLEREQ = 266,               // SMALLEREQ
    SMALLER = 267,                 // SMALLER
    GREATEREQ = 268,               // GREATEREQ
    GREATER = 269,                 // GREATER
    RANGE = 270                    // RANGE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_OR = 10,                               // OR
        S_EQUALS = 11,                           // EQUALS
        S_CONTAINS = 12,                         // CONTAINS
        S_SMALLEREQ = 13,                        // SMALLEREQ
        S_SMALLER = 14,                          // SMALLER
        S_GREATEREQ = 15,                        // GREATEREQ
        S_GREATER = 16,                          // GREATER
        S_RANGE = 17,                            // RANGE
        S_18_ = 18,                              // ')'
        S_YYACCEPT = 19,                         // $accept
        S_topquery = 20,                         // topquery
        S_query = 21,                            // query
        S_fieldexpr = 22,                        // fieldexpr
        S_complexfieldname = 23,                 // complexfieldname
        S_range = 24,                            // range
        S_term = 25,                             // term
        S_qualquote = 26                         // qualquote
      };
    };
