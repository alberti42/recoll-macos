...
// Work with path (slashized) like //host/share/path. On return, uncvolume contains the
// //host/share part. We take care to reject values with empty host or share parts which maybe
// somehow generated by other strange parts in recoll
